...
- Cài đặt và  cấu hình dịch vụ  OpenStack Networking Service, các thành phần dưới đây nằm trong service Networking được cài trên các Controlller Node . Cấu hình sử dụng OpenvSwitch làm network agent
