...
- Lưu ý : kể từ bản MariaDB 10.1 trở lên. Galera Cluster đã được tích hợp sẵn  MariaDB Server Package. Điều này có có nghĩa khi cài MariaDB MariaDB Server sẽ cài thêm cả M
