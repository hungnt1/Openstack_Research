...
## 2. Khởi tạo Load Balancer sử dụng IP Private
...
## 2. Khởi tạo Load Balancer sử dụng IP Public
...
```
[root@controller ~]#  openstack loadbalancer member create --subnet-id PUBLIC_IP_30 --address 192.168.30.150 --protocol-port 80  d0b7ee78-27e0-4b4a-9bb8-bbba416b8995
+---------------------+--------------------------------------+
| Field               | Value                                |
+---------------------+--------------------------------------+
...
+---------------------+--------------------------------------+
[root@controller ~]# openstack loadbalancer member create --subnet-id PUBLIC_IP_30 --address 192.168.30.146 --protocol-port 80 d0b7ee78-27e0-4b4a-9bb8-bbba416b8995
+---------------------+--------------------------------------+
| Field               | Value                                |
+---------------------+--------------------------------------+
| address             | 192.168.30.146                       |
| admin_state_up      | True                                 |
