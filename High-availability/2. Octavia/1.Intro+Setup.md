...
```
octavia-diskimage-create.sh -r 123@123Aa -c /root -o ubuntu-ha
openstack image create amphora-x64 --public --container-format bare --disk-format qcow2 --file /root/ubuntu-ha.qcow2
