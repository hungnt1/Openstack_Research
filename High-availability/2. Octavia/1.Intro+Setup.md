...
- Khởi tạo network và subnet cho cân bằng tải
```
...
- Khởi tại network để liên hệ giữa các thành phần trong Octavia ( ID trả về : f0994bc7-701b-4b6d-8073-65d770e66112) 
```
...
- Khởi tạo và upload một image mới cho máy ảo Amphora ( đảm nhiệm là Load Balancer - ID trả về : 5dc22764-d922-4069-87e8-e29d5fdb3f04 )
```
...
amp_boot_network_list = d73f342e-8775-437f-b555-94a1c108a9c8
