...
Create an amphora management network in RegionOne
...
Listening on LPF/o-hm0/fa:16:3e:72:0d:a0
	Sending on   LPF/o-hm0/fa:16:3e:72:0d:a0
	Sending on   Socket/fallback
	DHCPDISCOVER on o-hm0 to 255.255.255.255 port 67 interval 6 (xid=0x739052ea)
	DHCPREQUEST on o-hm0 to 255.255.255.255 port 67 (xid=0x739052ea)
	DHCPOFFER from 192.168.130.2
	DHCPACK from 192.168.130.2 (xid=0x739052ea)
	bound to 192.168.130.5 -- renewal in 32604 seconds.
...
connection = mysql+pymysql://octavia:octavia_123@controller/neutron
...
amp_secgroup_list = ce6fd5ce-de4c-43fe-927a-f2a1103a34bd
amp_boot_network_list = 5cb04d80-c822-45dd-bd61-0d7fc1f2fcd0
network_driver = allowed_address_pairs_driver
compute_driver = compute_nova_driver
amphora_driver = amphora_haproxy_rest_driver
loadbalancer_topology = SINGLE
amp_image_id = d9da0343-1a59-458a-97e9-86663216f825
