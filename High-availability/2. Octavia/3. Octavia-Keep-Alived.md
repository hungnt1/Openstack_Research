...
## Cấu hình HA Proxy và Keep Alived trong Octavia
...
- Kiểm tra namspace trên các VM aphora sẽ thấy : port tham gia vào quá trình VRRP , port vIP và port WebServer Network
